...
GRAVEL_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
            # proportion=0.8, noise_range=(-0.02, 0.04), noise_step=0.02, border_width=0.25
...
#     use_cache=False,
#     sub_terrains={
#         "flat_terrain": terrain_gen.HfRandomUniformTerrainCfg(
#             proportion=0.8, noise_range=(-0.02, 0.04), noise_step=0.02, border_width=0.2
#         ),
#         "flat": terrain_gen.MeshPlaneTerrainCfg(
#             proportion=0.2
#         ),
