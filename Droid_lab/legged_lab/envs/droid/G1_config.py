...
from legged_lab.assets.droid import G1_CFG
...
class G1RewardCfg(RewardCfg):
    ...
    undesired_contacts = RewTerm(func=mdp.undesired_contacts, weight=-1.0,
                                 params={"sensor_cfg": SceneEntityCfg("contact_sensor", body_names="(?!.*ankle.*).*"),
                                         "threshold": 1.0})
    fly = RewTerm(func=mdp.fly, weight=-1.0,
                  params={"sensor_cfg": SceneEntityCfg("contact_sensor", body_names=".*ankle_roll.*"),
                          "threshold": 1.0})
    body_orientation_l2 = RewTerm(func=mdp.body_orientation_l2,
                                  params={"asset_cfg": SceneEntityCfg("robot", body_names="pelvis")}, weight=-5.0)
    flat_orientation_l2 = RewTerm(func=mdp.flat_orientation_l2, weight=-2.0)
    termination_penalty = RewTerm(func=mdp.is_terminated, weight=-200.0)
    # === 脚部接触类 ===
    feet_air_time = RewTerm(func=mdp.feet_air_time_positive_biped, weight=0.50,
                            params={"sensor_cfg": SceneEntityCfg("contact_sensor", body_names=".*ankle_roll.*"),
                                    "threshold": 0.5})
    feet_slide = RewTerm(func=mdp.feet_slide, weight=-0.10,
                         params={"sensor_cfg": SceneEntityCfg("contact_sensor", body_names=".*ankle_roll.*"),
                                 "asset_cfg": SceneEntityCfg("robot", body_names=".*_ankle_roll.*")})
    feet_force = RewTerm(func=mdp.body_force, weight=-3e-3,
                         params={"sensor_cfg": SceneEntityCfg("contact_sensor", body_names=".*ankle_roll.*"),
                                 "threshold": 500, "max_reward": 400})
    feet_too_near = RewTerm(func=mdp.feet_too_near_humanoid, weight=-1.0,
                            params={"asset_cfg": SceneEntityCfg("robot", body_names=[".*ankle_roll.*"]),
                                    "threshold": 0.3})
    feet_stumble = RewTerm(func=mdp.feet_stumble, weight=-1.0,
                           params={"sensor_cfg": SceneEntityCfg("contact_sensor", body_names=[".*ankle_roll.*"])})
    # === 关节约束 ===
    dof_pos_limits = RewTerm(func=mdp.joint_pos_limits, weight=-1.5)
    joint_deviation_waist_yaw = RewTerm(func=mdp.joint_deviation_l1, weight=-1.0, params={
        "asset_cfg": SceneEntityCfg("robot", joint_names=[".*waist_yaw_joint"])})
    joint_deviation_hip_yaw = RewTerm(func=mdp.joint_deviation_l1, weight=-1.0,
                                      params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_hip_yaw_joint"])})
    joint_deviation_hip_roll = RewTerm(func=mdp.joint_deviation_l1, weight=-1.0,
    ...
    joint_deviation_legs = RewTerm(func=mdp.joint_deviation_l1, weight=-0.02,
                                   params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_hip_pitch_joint"])})
    joint_deviation_legs_knee = RewTerm(func=mdp.joint_deviation_l1, weight=-0.01,
                                        params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_knee.*"])})
    joint_deviation_feet = RewTerm(func=mdp.joint_deviation_l1, weight=-0.02,
                                   params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_ankle_pitch.*"])})
    joint_deviation_ankle = RewTerm(func=mdp.joint_deviation_l1, weight=-1.0,
                                    params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_ankle_roll.*"])})
    feet_swings = RewTerm(func=mdp.feet_swing, weight=1.0,
    ...
    dof_torque_limits = RewTerm(func=mdp.torque_limits, weight=-1.0, params={"asset_cfg": SceneEntityCfg("robot",
                                                                                                         joint_names=[
                                                                                                             ".*waist_yaw_joint",
                                                                                                             ".*_hip_yaw_joint",
                                                                                                             ".*_hip_roll_joint",
    ...
    dof_vel_limits = RewTerm(func=mdp.dof_vel_limits, weight=-1.0, params={"asset_cfg": SceneEntityCfg("robot",
                                                                                                       joint_names=[
                                                                                                           ".*waist_yaw_joint",
                                                                                                           ".*_hip_yaw_joint",
                                                                                                           ".*_hip_roll_joint",
